...
if variavel ==2
    ...
    espacamento = input("insira o espaçamento entre os centros: ");
...
Xc = (1.779/60) * 10^6 * log(espacamento/r);

Xc_disp = sprintf("A reatancia capacitiva é %d Ohms/mi para o neutro",Xc);

Bc = 1/Xc;

Bc_disp = sprintf("A suceptancia é %d S/mi para o neutro",Bc);
